...
-- commented by markus.zinggl@outlook.com

local floor = math.floor

---@class PriorityQueue
---@field public empty fun(self: PriorityQueue): boolean
---@field public size fun(self: PriorityQueue): integer
---@field public put fun(self: PriorityQueue, v: any, p: number)
---@field public pop fun(self: PriorityQueue): any, number
---@field public peek fun(self: PriorityQueue): any, number
---@field private initialize fun(self: PriorityQueue)
---@field private swim fun(self: PriorityQueue)
---@field private sink fun(self: PriorityQueue)
---@field private min_child fun(self: PriorityQueue, i: integer): integer
---@field private heap_val any
---@field private heap_pri number[]
---@field private current_size integer
---
local PriorityQueue = {}
